...
String query = "SELECT o.ORDER_ID, ORDER_DATE, STATUS, p.CUSTOMER_ID , p.PAYMENT_ID , p.PAYMENT_METHOD , p.BILL FROM orders o , payments p  Where o.ORDER_ID = p.ORDER_ID" ;
